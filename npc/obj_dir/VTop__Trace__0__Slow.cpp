...
VL_ATTR_COLD void VTop___024root__trace_init_sub__TOP__0(VTop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+69,"is_ebreak", false,-1);
    tracep->declQuad(c+70,"src2_result", false,-1, 63,0);
    ...
    tracep->declBit(c+69,"is_ebreak", false,-1);
    tracep->declQuad(c+70,"src2_result", false,-1, 63,0);
    tracep->declBus(c+72,"snpc", false,-1, 31,0);
    tracep->declBus(c+73,"rs1", false,-1, 4,0);
    tracep->declBus(c+74,"rs2", false,-1, 4,0);
    tracep->declBus(c+75,"rd", false,-1, 4,0);
    tracep->declQuad(c+76,"imm", false,-1, 63,0);
    tracep->declBit(c+78,"is_addi", false,-1);
    tracep->declQuad(c+79,"src1", false,-1, 63,0);
    tracep->declQuad(c+70,"src2", false,-1, 63,0);
    tracep->declQuad(c+81,"wdata", false,-1, 63,0);
    ...
    tracep->declBus(c+84,"funct3", false,-1, 2,0);
    tracep->declBus(c+85,"imm_i", false,-1, 11,0);
    ...
    tracep->declBus(c+86,"ADDR_WIDTH", false,-1, 31,0);
...
VL_ATTR_COLD void VTop___024root__trace_full_sub_0(VTop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+69,(vlSelf->is_ebreak));
    bufp->fullQData(oldp+70,(vlSelf->src2_result),64);
    bufp->fullIData(oldp+72,(((IData)(4U) + vlSelf->pc)),32);
    ...
    bufp->fullCData(oldp+75,((0x1fU & (vlSelf->inst 
                                       >> 7U))),5);
    bufp->fullQData(oldp+76,((((- (QData)((IData)((vlSelf->inst 
                                                   >> 0x1fU)))) 
                               << 0xcU) | (QData)((IData)(
                                                          (vlSelf->inst 
                                                           >> 0x14U))))),64);
    bufp->fullBit(oldp+78,((IData)((0x13U == (0x707fU 
                                              & vlSelf->inst)))));
    bufp->fullQData(oldp+79,(vlSelf->Top__DOT__regfile_i__DOT__rf
                             [(0x1fU & (vlSelf->inst 
                                        >> 0xfU))]),64);
    bufp->fullQData(oldp+81,(((((- (QData)((IData)(
                                                   (vlSelf->inst 
                                                    >> 0x1fU)))) 
                                << 0xcU) | (QData)((IData)(
                                                           (vlSelf->inst 
