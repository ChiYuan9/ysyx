...
void VTop___024root__trace_chg_sub_0(VTop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+68,(vlSelf->is_ebreak));
    bufp->chgQData(oldp+69,(vlSelf->src2_result),64);
    bufp->chgIData(oldp+71,(((IData)(4U) + vlSelf->pc)),32);
    ...
    bufp->chgCData(oldp+74,((0x1fU & (vlSelf->inst 
                                      >> 7U))),5);
    bufp->chgQData(oldp+75,((((- (QData)((IData)((vlSelf->inst 
                                                  >> 0x1fU)))) 
                              << 0xcU) | (QData)((IData)(
                                                         (vlSelf->inst 
                                                          >> 0x14U))))),64);
    bufp->chgBit(oldp+77,((IData)((0x13U == (0x707fU 
                                             & vlSelf->inst)))));
    bufp->chgQData(oldp+78,(vlSelf->Top__DOT__regfile_i__DOT__rf
                            [(0x1fU & (vlSelf->inst 
                                       >> 0xfU))]),64);
    bufp->chgQData(oldp+80,(((((- (QData)((IData)((vlSelf->inst 
                                                   >> 0x1fU)))) 
                               << 0xcU) | (QData)((IData)(
                                                          (vlSelf->inst 
                                                           >> 0x14U)))) 
                             ...
                             [(0x1fU & (vlSelf->inst 
                                        >> 0xfU))])),64);
    bufp->chgCData(oldp+82,((0x7fU & vlSelf->inst)),7);
